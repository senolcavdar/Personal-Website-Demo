...
<body>	
	<div class="limiter">
        ...
        <?php } elseif (@$_GET['register'] == 'inequal'){ ?>
            <div class="alert alert-danger alert-dismissible fade in" role="alert"  style="width: 400px; font-size: 15px; margin-top: -10px; margin-bottom: 25px;">
                    <strong>Hata!</strong> Şifreler aynı değil.
                    <button type="button" style="margin-top: 3px;" class="close" data-dismiss="alert" aria-label="Close" ><span aria-hidden="true">×</span>
                    </button>
        </div> 
        <?php } ?>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="password_1" placeholder="Şifre">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="password_2" placeholder="Şifre Tekrarı">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					...
					</div><div class="text-center p-t-30">
